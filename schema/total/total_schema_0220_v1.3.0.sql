...
INSERT INTO seller_representative (
    ...
    1,
    (SELECT id from sellers WHERE account='seller1' LIMIT 1),
    01011111111,
    TRUE
),
(
...
(
    4,
    (SELECT id from sellers WHERE account='seller2' LIMIT 1),
    01022222222,
    TRUE   
),
(
...
(
    7,
    (SELECT id from sellers WHERE account='seller3' LIMIT 1),
    01033333333,
    TRUE   
),
(
...
(
    10,
    (SELECT id from sellers WHERE account='seller4' LIMIT 1),
    01044444444,
    TRUE   
),
(
...
(
    13,
    (SELECT id from sellers WHERE account='seller5' LIMIT 1),
    01055555555,
    TRUE   
),
(
...
(
    16,
    (SELECT id from sellers WHERE account='seller6' LIMIT 1),
    01066666666,
    TRUE   
),
(
...
(
    19,
    (SELECT id from sellers WHERE account='seller7' LIMIT 1),
    01077777777,
    TRUE   
),
(
...
(
    22,
    (SELECT id from sellers WHERE account='seller8' LIMIT 1),
    01088888888,
    TRUE   
),
(
...
(
    25,
    (SELECT id from sellers WHERE account='seller9' LIMIT 1),
    01099999999,
    TRUE   
),
(
...
(
    28,
    (SELECT id from sellers WHERE account='seller10' LIMIT 1),
    01010101010,
    TRUE   
),
(
...
(
    10,
    (SELECT id from first_categories WHERE name='스커트' LIMIT 1),
    (SELECT id from second_categories WHERE name='미니스커트' LIMIT 1),
    TRUE
),
(
    11,
    (SELECT id from first_categories WHERE name='스커트' LIMIT 1),
    (SELECT id from second_categories WHERE name='롱스커트' LIMIT 1),
    TRUE
),
(
    12,
    (SELECT id from first_categories WHERE name='바지' LIMIT 1),
    (SELECT id from second_categories WHERE name='청바지' LIMIT 1),
    TRUE
),
(
    13,
    (SELECT id from first_categories WHERE name='바지' LIMIT 1),
    (SELECT id from second_categories WHERE name='슬랙스' LIMIT 1),
    TRUE
),
(
    14,
    (SELECT id from first_categories WHERE name='바지' LIMIT 1),
    (SELECT id from second_categories WHERE name='반바지' LIMIT 1),
    TRUE
),
(
    15,
    (SELECT id from first_categories WHERE name='바지' LIMIT 1),
    (SELECT id from second_categories WHERE name='레깅스' LIMIT 1),
    TRUE
),
(
    16,
    (SELECT id from first_categories WHERE name='신발' LIMIT 1),
    (SELECT id from second_categories WHERE name='스니커즈' LIMIT 1),
    TRUE
),
(
    17,
    (SELECT id from first_categories WHERE name='신발' LIMIT 1),
    (SELECT id from second_categories WHERE name='부츠' LIMIT 1),
    TRUE
),
(
    18,
    (SELECT id from first_categories WHERE name='신발' LIMIT 1),
    (SELECT id from second_categories WHERE name='힐' LIMIT 1),
    TRUE
),
(
    19,
    (SELECT id from first_categories WHERE name='신발' LIMIT 1),
    (SELECT id from second_categories WHERE name='플랫/로퍼' LIMIT 1),
    TRUE
),
(
    20,
    (SELECT id from first_categories WHERE name='신발' LIMIT 1),
    (SELECT id from second_categories WHERE name='샌들' LIMIT 1),
    TRUE
),
(
    21,
    (SELECT id from first_categories WHERE name='가방' LIMIT 1),
    (SELECT id from second_categories WHERE name='크로스백' LIMIT 1),
    TRUE
),
(
    22,
    (SELECT id from first_categories WHERE name='가방' LIMIT 1),
    (SELECT id from second_categories WHERE name='클러치' LIMIT 1),
    TRUE
),
(
    23,
    (SELECT id from first_categories WHERE name='가방' LIMIT 1),
    (SELECT id from second_categories WHERE name='숄더백' LIMIT 1),
    TRUE
),
(
    24,
    (SELECT id from first_categories WHERE name='가방' LIMIT 1),
    (SELECT id from second_categories WHERE name='토트백' LIMIT 1),
    TRUE
),
(
    25,
    (SELECT id from first_categories WHERE name='가방' LIMIT 1),
    (SELECT id from second_categories WHERE name='백팩' LIMIT 1),
    TRUE
),
(
    26,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='휴대폰케이스' LIMIT 1),
    TRUE
),
(
    27,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='지갑/파우치' LIMIT 1),
    TRUE
),
(
    28,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='스카프/머플러' LIMIT 1),
    TRUE
),
(
    29,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='모자' LIMIT 1),
    TRUE
),
(
    30,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='양말' LIMIT 1),
    TRUE
),
(
    31,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='시계' LIMIT 1),
    TRUE
),
(
    32,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='아이웨어' LIMIT 1),
    TRUE
),
(
    33,
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1),
    (SELECT id from second_categories WHERE name='기타' LIMIT 1),
    TRUE
),
(
    34,
    (SELECT id from first_categories WHERE name='주얼리' LIMIT 1),
    (SELECT id from second_categories WHERE name='귀걸이' LIMIT 1),
    TRUE
),
(
    35,
    (SELECT id from first_categories WHERE name='주얼리' LIMIT 1),
    (SELECT id from second_categories WHERE name='목걸이/팔찌' LIMIT 1),
    TRUE
),
(
    36,
    (SELECT id from first_categories WHERE name='주얼리' LIMIT 1),
    (SELECT id from second_categories WHERE name='반지' LIMIT 1),
    TRUE
),
(
    37,
    (SELECT id from first_categories WHERE name='라이프웨어' LIMIT 1),
    (SELECT id from second_categories WHERE name='언더웨어' LIMIT 1),
    TRUE
),
(
    38,
    (SELECT id from first_categories WHERE name='라이프웨어' LIMIT 1),
    (SELECT id from second_categories WHERE name='홈웨어' LIMIT 1),
    TRUE
),
(
    39,
    (SELECT id from first_categories WHERE name='라이프웨어' LIMIT 1),
    (SELECT id from second_categories WHERE name='스윔웨어' LIMIT 1),
    TRUE
)
;
...
INSERT INTO basic_options_colors (id, name, is_used) VALUES(11, 'Yellow', TRUE);
INSERT INTO basic_options_colors (id, name, is_used) VALUES(12, 'Burgundy', TRUE);
INSERT INTO basic_options_colors (id, name, is_used) VALUES(13, 'Red', TRUE);
INSERT INTO basic_options_colors (id, name, is_used) VALUES(14, 'Orange', TRUE);
...
INSERT INTO basic_options_sizes (id, name, is_used) VALUES(10, '100', TRUE);
INSERT INTO basic_options_sizes (id, name, is_used) VALUES(11, '95', TRUE);
INSERT INTO basic_options_sizes (id, name, is_used) VALUES(12, '90', TRUE);
...
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (1, 4, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (2, 5, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (3, 6, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (4, 7, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (5, 8, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (6, 9, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (7, 10, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (8, 11, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (9, 12, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (10, 13, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (11, 14, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (12, 15, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (13, 16, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (14, 17, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (15, 18, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (16, 19, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (17, 20, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (18, 21, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (19, 22, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (20, 23, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (21, 24, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (22, 25, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (23, 26, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (24, 27, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (25, 28, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (26, 29, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (27, 30, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (28, 31, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (29, 32, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (30, 33, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (31, 34, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (32, 35, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (33, 36, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (34, 37, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (35, 38, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (36, 39, FALSE, NULL, TRUE);
INSERT INTO no_option (id, option_info_id, is_stock_managed, stock_volume, is_used) VALUES (37, 40, FALSE, NULL, TRUE);
...
(
    61, -- id 자율/독립/할인 선택
    '티셔츠', -- name (required when registering)
    61, -- product_number
    'CV00000000000000061', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '티셔츠_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/13664414_1581264937_image61_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '티셔츠_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=61 LIMIT 1), -- option_info_id (required when registering)
    61000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    62, -- id 자율/독립/할인 선택
    '니트', -- name (required when registering)
    62, -- product_number
    'CV00000000000000062', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '니트_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/13663527_1581262334_image62_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '니트_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=62 LIMIT 1), -- option_info_id (required when registering)
    62000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    63, -- id 자율/독립/할인 선택
    '블라우스', -- name (required when registering)
    63, -- product_number
    'CV00000000000000063', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '블라우스_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/13473898_1580479046_image63_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '블라우스_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=63 LIMIT 1), -- option_info_id (required when registering)
    63000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    64, -- id 자율/독립/할인 선택
    '빨강니트', -- name (required when registering)
    64, -- product_number
    'CV00000000000000064', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '빨강니트_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/13362111_1580042998_image64_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '빨강니트_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=64 LIMIT 1), -- option_info_id (required when registering)
    64000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    65, -- id 자율/독립/할인 선택
    '리본블라우스', -- name (required when registering)
    65, -- product_number
    'CV00000000000000065', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '리본블라우스_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/12393174_1575496354_image65_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '리본블라우스_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=65 LIMIT 1), -- option_info_id (required when registering)
    65000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    66, -- id 자율/독립/할인 선택
    '원피스', -- name (required when registering)
    66, -- product_number
    'CV00000000000000066', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '원피스_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/11806093_1573516848_image66_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '원피스_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=66 LIMIT 1), -- option_info_id (required when registering)
    66000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    67, -- id 자율/독립/할인 선택
    '청바지', -- name (required when registering)
    67, -- product_number
    'CV00000000000000067', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    (SELECT id from first_categories WHERE name='바지' LIMIT 1), -- first_categories_id (required when registering)
    (SELECT id from second_categories WHERE name='청바지' LIMIT 1), -- second_categories_id (required when registering)
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '청바지_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/10941574_1570086978_image67_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '청바지_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=67 LIMIT 1), -- option_info_id (required when registering)
    67000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    68, -- id 자율/독립/할인 선택
    '립스틱', -- name (required when registering)
    68, -- product_number
    'CV00000000000000068', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    (SELECT id from first_categories WHERE name='잡화' LIMIT 1), -- first_categories_id (required when registering)
    (SELECT id from second_categories WHERE name='기타' LIMIT 1), -- second_categories_id (required when registering)
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '립스틱_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/10686470_1581671848_image68_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '립스틱_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=68 LIMIT 1), -- option_info_id (required when registering)
    68000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    69, -- id 자율/독립/할인 선택
    '화장품', -- name (required when registering)
    69, -- product_number
    'CV00000000000000069', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    FALSE, -- information_notice_use
    NULL,-- information_notices_id
    '화장품_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/6362827_1581906950_image69_M.jpg', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '화장품_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=69 LIMIT 1), -- option_info_id (required when registering)
    69000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
(
    ...
    '티셔츠', -- name (required when registering)
    70, -- product_number
    'CV00000000000000070', -- serial_number
    FALSE, -- is_temporary_save
    TRUE, -- is_sold
    TRUE, -- is_displayed
    TRUE, -- is_used
    ...
    NULL,-- information_notices_id
    '티셔츠_한줄설명', -- one_line_description
    'https://s3-vugue-test.s3.ap-northeast-2.amazonaws.com/6b217455bb9dacb6fa1addd42dc4ecdb_image70.JPG', -- main_image (required when registering)
    NULL, -- image_1
    NULL, -- image_2
    NULL, -- image_3
    NULL, -- image_4
    '티셔츠_상세설명', -- detailed_info (required when registering)
    NULL, -- youtube_url
    (SELECT id from option_info WHERE id=70 LIMIT 1), -- option_info_id (required when registering)
    70000, -- price
    NULL, -- discount_rate
    NULL, -- discount_price
    NULL, -- discounted_price
...
INSERT INTO products_counts (id, is_used) VALUES (21, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (22, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (23, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (24, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (25, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (26, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (27, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (28, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (29, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (30, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (31, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (32, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (33, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (34, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (35, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (36, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (37, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (38, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (39, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (40, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (41, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (42, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (43, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (44, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (45, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (46, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (47, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (48, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (49, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (50, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (51, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (52, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (53, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (54, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (55, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (56, TRUE);
INSERT INTO products_counts (id, is_used) VALUES (57, TRUE);
