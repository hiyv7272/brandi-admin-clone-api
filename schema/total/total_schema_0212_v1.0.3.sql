...
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('1', '공지사항', '1', '', 'icon-speech');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('2', '공지사항', '1', '브랜디 공지', '/brandi/notice/notice_lists');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('3', '공지사항', '1', '기획전 상품 신청', '/brandi/events/join');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('4', '통계', '4', '', 'icon-bar-chart');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('5', '통계', '4', '시간단위분석', '/brandi/statistics/per_time');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('6', '통계', '4', 'KPI_커머스', '/brandi/cstatistics/kpi');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('7', '통계', '4', 'KPI_커뮤니티', '/brandi/statistics/kpi');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('8', '통계', '4', '리텐션', '/brandi/statistics/retention');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('9', '통계', '4', '판매분석(상품)', '/brandi/cstatistics/salesAnalysisProduct');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('10', '통계', '4', '판매분석(셀러)', '/brandi/cstatistics/salesAnalysisSeller');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('11', '통계', '4', '추세분석(상품)', '/brandi/cstatistics/trendAnalysisProduct');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('12', '통계', '4', '추세분석(셀러)', '/brandi/cstatistics/trendAnalysisSeller');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('13', '주문관리', '13', '', 'icon-basket-loaded');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('14', '주문관리', '13', '전체주문 관리', '/brandi/order/masterAllOrderList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('15', '주문관리', '13', '결제대기관리', '/brandi/order/masterPaymentWatingList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('16', '주문관리', '13', '결제완료관리', '/brandi/order/masterPaymentCompleteList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('17', '주문관리', '13', '상품준비관리', '/brandi/order/masterProductPrepareList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('18', '주문관리', '13', '배송준비관리', '/brandi/order/masterDeliveryPrepareList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('19', '주문관리', '13', '배송중관리', '/brandi/order/masterDeliveryList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('20', '주문관리', '13', '배송완료관리', '/brandi/order/masterDeliveryCompleteList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('21', '주문관리', '13', '구매확정관리', '/brandi/order/masterOrderConfirmList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('22', '취소/환불 관리', '22', '', 'icon-basket');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('23', '취소/환불 관리', '22', '환불요청관리', '/brandi/refund_order/masterRefundRequestList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('24', '취소/환불 관리', '22', '반품진행관리', '/brandi/refund_order/masterRefundGoodsList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('25', '취소/환불 관리', '22', '환불승인중관리', '/brandi/refund_order/masterRefundConfirmList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('26', '취소/환불 관리', '22', '환불완료관리', '/brandi/refund_order/masterRefundCompleteList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('27', '취소/환불 관리', '22', '주문취소중관리', '/brandi/refund_order/masterCancelConfirmList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('28', '취소/환불 관리', '22', '주문취소완료관리', '/brandi/refund_order/masterCancelCompleteList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('29', '취소/환불 관리', '22', '환불요청관리', '/brandi/refund_order/sellerRefundRequestList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('30', '취소/환불 관리', '22', '반품진행관리', '/brandi/refund_order/sellerRefundGoodsList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('31', '취소/환불 관리', '22', '환불승인중관리', '/brandi/refund_order/sellerRefundConfirmList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('32', '취소/환불 관리', '22', '환불완료관리', '/brandi/refund_order/sellerRefundCompleteList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('33', '취소/환불 관리', '22', '주문취소중관리', '/brandi/refund_order/sellerCancelConfirmList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('34', '취소/환불 관리', '22', '주문취소완료관리', '/brandi/refund_order/sellerCancelCompleteList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('35', '상품관리', '35', '', 'icon-handbag');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('36', '상품관리', '35', '상품 관리', '/brandi/cproduct');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('37', '상품관리', '35', '상품 등록', '/brandi/cproduct/productRegistPage');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('38', '상품관리', '35', '럭키투데이 관리', '/brandi/cproduct/luckyTodayList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('39', '상품관리', '35', '연동상품관리', '/connecti/product');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('40', '상품관리', '35', '연동상품 카테고리관리', '/connecti/category');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('41', '외부채널연동상품 관리', '41', '', 'icon-share');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('42', '외부채널연동상품 관리', '41', '연동상품관리', '/connecti/external');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('43', '외부채널연동상품 관리', '41', '수동연동관리', '/connecti/external/manual');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('44', '고객응대관리', '44', '', 'icon-emoticon-smile');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('45', '고객응대관리', '44', 'CRM 관리 (고객)', '/brandi/crm/customer');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('46', '고객응대관리', '44', 'CRM 관리 (셀러)', '/brandi/crm/seller');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('47', '고객응대관리', '44', 'Q&A 관리', '/brandi/inquiry/inquiry_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('48', '고객응대관리', '44', '텍스트 리뷰', '/brandi/review/textReviewList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('49', '고객응대관리', '44', '포토 리뷰', '/brandi/review/photoReviewList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('50', '고객응대관리', '44', '인증번호 관리', '/brandi/certificationCode/certificationCodeDetail');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('51', '정산관리', '45', '', 'icon-calculator');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('52', '정산관리', '45', '정산 관리', '/brandi/calculate/calculate_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('53', '정산관리', '45', '정산요약', '/brandi/excclcOrder');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('54', '정산관리', '45', '셀러별 정산요약', '/brandi/excclcOrderResult');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('55', '정산관리', '45', '판매수수료 요약', '/brandi/excclc/excclc_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('56', '정산관리', '45', '셀러별 판매수수료', '/brandi/excclcResult/excclcResult_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('57', '정산관리', '45', '주문별 판매수수료', '/brandi/excclcResultDetail/excclcResultDetail_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('58', '정산관리', '45', '서버 이용료 요약', '/brandi/excclc/serverFee_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('59', '정산관리', '45', '셀러별 서버이용료', '/brandi/excclcResult/serverFeeResult_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('60', '정산관리', '45', '상품수수료', '/brandi/productFeeGroup/productFeeGroup_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('61', '정산관리', '45', '판매자수수료할인', '/brandi/mdFeeGroup/mdFeeGroup_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('62', '정산관리', '45', '기본수수료관리', '/brandi/mdBasisFee/mdBasisFee_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('63', '정산관리', '45', '헬피수수료관리', '/brandi/partnerFeeGroup/partnerFeeGrouplist');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('64', '정산관리', '45', '광고수수료관리', '/settlement/fee/advFee');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('65', '정산관리', '45', '서버비 면제 대상', '/brandi/serverRntfee');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('66', '정산관리', '45', '정산제외대상', '/brandi/excclcExclusion/excclcExclusionList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('67', '정산관리', '45', '판매회원등급관리', '/brandi/mdGrade/mdGrade_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('68', '진열관리', '68', '', 'icon-eye');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('69', '진열관리', '68', '(iOS) 홈 - 홈 탭 진열관리', '/brandi/exhibition/homeTabExhibition/iOS');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('70', '진열관리', '68', '(AOS) 홈 - 홈 탭 진열관리', '/brandi/exhibition/homeTabExhibition/AOS');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('71', '진열관리', '68', '홈 - 베스트 탭 진열관리', '/brandi/exhibition/bestTabExhibition');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('72', '진열관리', '68', '(iOS) 홈 - 쇼핑몰·마켓 탭 진열관리', '/brandi/exhibition/trendTabExhibition/iOS');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('73', '진열관리', '68', '(AOS) 홈 - 쇼핑몰·마켓 탭 진열관리', '/brandi/exhibition/trendTabExhibition/AOS');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('74', '진열관리', '68', '홈 - 브랜드 탭 진열관리', '/brandi/exhibition/brandTabExhibition');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('75', '진열관리', '68', '홈 - 뷰티 탭 진열관리', '/brandi/exhibition/beautyTabExhibition');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('76', '진열관리', '68', '홈 - 특가 탭 진열관리', '/brandi/cproduct/spclpc');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('77', '진열관리', '68', '카테고리 진열관리', '/brandi/exhibition/categoryExhibition');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('78', '진열관리', '68', '스토어 진열 관리', '/brandi/seller/market_exhbi_mngr');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('79', '진열관리', '68', '스플래시 이미지 관리', '/brandi/image_control');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('80', '진열관리', '68', '스토어 상세 진열 관리', '/brandi/seller/market_detail_exhbi_mngr');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('81', '진열관리', '68', '배너 관리', '/brandi/design/commerceBannerControl');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('82', '기획전/쿠폰관리', '82', '', 'icon-present');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('83', '기획전/쿠폰관리', '82', '기획전 관리', '/brandi/events');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('84', '기획전/쿠폰관리', '82', '기획전 댓글 관리', '/brandi/events/event_answer_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('85', '기획전/쿠폰관리', '82', '포인트 관리', '/brandi/coupon/coupon_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('86', '기획전/쿠폰관리', '82', '쿠폰 관리', '/brandi/coupon/prduct_coupon_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('87', '기획전/쿠폰관리', '82', '포인트 일괄 지급', '/brandi/coupon/pointProcess');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('88', '푸시', '88', '', 'icon-bell');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('89', '푸시', '88', '푸시 발송', '/brandi/push');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('90', '푸시', '88', '푸시 메시지 목록', '/brandi/push/message');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('91', '회원관리', '91', '', 'icon-user');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('92', '회원관리', '91', '회원 관리_커뮤니티', '/brandi/member');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('93', '회원관리', '91', '회원 관리_커머스', '/brandi/member/commerce_member');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('94', '회원관리', '91', '회원 그룹 관리', '/brandi/member/group');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('95', '회원관리', '91', '셀러 정보 관리', '/brandi/seller/seller_my_page');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('96', '회원관리', '91', '페널티 셀러 관리', '/brandi/sellerPenalty/penaltyList');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('97', '회원관리', '91', '회원 탈퇴 관리', '/brandi/member/delete');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('98', '회원관리', '91', '셀러 계정 관리', '/brandi/account');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('99', '회원관리', '91', '도매처 관리', '/brandi/wholesale');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('100', '기타', '100', '', 'icon-equalizer');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('101', '기타', '100', '단축 URL 공유', '/brandi/shorten');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('102', '기타', '100', '서비스 로그 목록', '/brandi/service_log');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('103', '기타', '100', '공휴일 관리', '/brandi/holiday');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('104', '기타', '100', '메뉴 권한 관리', '/brandi/authorGroup');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('105', '기타', '100', '브랜디 계정 관리', '/brandi/masterAccount');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('106', '기타', '100', '관리 도구', '/brandi/manageTool');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('107', '이전 버전 관리', '107', '', 'icon-settings');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('108', '이전 버전 관리', '107', '스토리관리', '/brandi/story');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('109', '이전 버전 관리', '107', '브랜드 관리', '/brandi/brand');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('110', '이전 버전 관리', '107', '브랜드 신청 관리', '/brandi/brand_recommend');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('111', '이전 버전 관리', '107', '아이템 관리', '/brandi/media');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('112', '이전 버전 관리', '107', '신고 아이템 관리', '/brandi/media/statement_list');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('113', '이전 버전 관리', '107', '댓글 관리', '/brandi/media/answer');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('114', '이전 버전 관리', '107', '접속', '/brandi/statistics/access');
INSERT INTO menu (id, topmenu, topmenu_id, name, url) VALUES ('115', '이전 버전 관리', '107', '카테고리 관리', '/brandi/category');
...
--  created_at,
    ...
    NULL, -- updated_at
    (SELECT id from accounts WHERE id=1 LIMIT 1), -- creator_id
    NULL -- changer_id
),
(
    2, -- id 자율/분리 선택
