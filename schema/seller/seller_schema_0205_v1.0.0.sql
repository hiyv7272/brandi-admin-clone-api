...
ALTER TABLE authorities COMMENT '권한 테이블';
...
(
    `id`              BIGINT          NOT NULL    AUTO_INCREMENT    COMMENT 'id', 
    `authorities_id`  BIGINT          NULL                          COMMENT '권한테이블_id', 
    `account`         VARCHAR(45)     NOT NULL                      COMMENT '계정', 
    `passowrd`        VARCHAR(300)    NOT NULL                      COMMENT '비밀번호', 
    PRIMARY KEY (id)
)ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

ALTER TABLE accounts COMMENT '계정 테이블';
...
INSERT INTO accounts (id, authorities_id, account, passowrd) VALUES ('1', '1', 'brandi', '1234');
...
ALTER TABLE menu COMMENT '메뉴 테이블';
...
(
    `id`           BIGINT         NOT NULL    AUTO_INCREMENT    COMMENT 'id', 
    `accounts_id`  BIGINT         NULL                          COMMENT '계정테이블_id', 
...
ALTER TABLE auth_groups COMMENT '권한그룹 테이블';
...
(
    `id`              BIGINT      NOT NULL    AUTO_INCREMENT    COMMENT 'id', 
    `auth_groups_id`  BIGINT      NULL                          COMMENT '권한그룹_id', 
    `authorities_id`  BIGINT      NULL                          COMMENT '권한테이블_id', 
    `menu_id`         BIGINT      NULL                          COMMENT '메뉴테이블_id', 
    `is_read`         TINYINT     NULL                          COMMENT '읽기권한', 
    `is_write`        TINYINT     NULL                          COMMENT '쓰기권한', 
...
ALTER TABLE auth_groups_menu COMMENT '권한그룹_메뉴 테이블';
...
ALTER TABLE auth_groups_menu
    ADD CONSTRAINT FK_aauth_groups_menu_auth_groups_id FOREIGN KEY (auth_groups_id)
...
(
    `id`                   BIGINT          NOT NULL    AUTO_INCREMENT   COMMENT 'id', 
    `accounts_id`          BIGINT          NULL                         COMMENT '계정테이블_id', 
    `auth_groups_menu_id`  BIGINT          NULL                         COMMENT '권한그룹_메뉴 테이블_id', 
...
ALTER TABLE masters COMMENT '마스터 테이블';
...
ALTER TABLE sellers_info COMMENT '셀러_정보 테이블';
...
ALTER TABLE seller_status COMMENT '셀러_상태 테이블';
...
ALTER TABLE tag_ages COMMENT '태그_연령대 테이블';
...
ALTER TABLE tag_styles COMMENT '태그_스타일 테이블';
...
ALTER TABLE seller_types COMMENT '셀러_타입 테이블';
...
ALTER TABLE fees COMMENT '수수료 테이블';
...
(
    ...
    `accounts_id`          BIGINT          NULL                         COMMENT '계정테이블_id', 
    `auth_groups_menu_id`  BIGINT          NULL                         COMMENT '권한그룹_메뉴 테이블_id', 
    `seller_types_id`      BIGINT          NULL                         COMMENT '셀러_타입테이블_id', 
    `seller_status_id`     BIGINT          NULL                         COMMENT '셀러_상태테이블_id', 
    `seller_info_id`       BIGINT          NULL                         COMMENT '셀러_정보테이블_id', 
    `fees_id`              BIGINT          NULL                         COMMENT '수수료테이블_id', 
    `tag_ages_id`          BIGINT          NULL                         COMMENT '태그_연령대테이블_id', 
    `tag_styles_id`        BIGINT          NULL                         COMMENT '태그_스타일테이블_id', 
    `account`              VARCHAR(20)     NOT NULL                     COMMENT '계정', 
    `password`             VARCHAR(300)    NOT NULL                     COMMENT '비밀번호', 
    `name_kr`              VARCHAR(45)     NOT NULL                     COMMENT '이름(한글)', 
    `name_en`              VARCHAR(45)     NOT NULL                     COMMENT '이름(영문)', 
...
ALTER TABLE sellers COMMENT '셀러 테이블';
...
(
    `id`             BIGINT         NOT NULL    AUTO_INCREMENT  COMMENT 'id', 
    `sellers_id`     BIGINT         NULL                        COMMENT '셀러테이블_id', 
...
ALTER TABLE seller_representative COMMENT '셀러_담당자 테이블';
...
ALTER TABLE seller_status_logs COMMENT '셀러_상태_로그 테이블';
...
(
    ...
    `model_bottom_size`        INT              NULL                        COMMENT '셀러모델_하의사이즈', 
    `model_foot_size`          INT              NULL                        COMMENT '셀러모델_발사이즈', 
    `soipping_message`         VARCHAR(1000)    NOT NULL                    COMMENT '쇼핑피드_업데이트_메세지', 
    `created_at`               DATETIME         NULL                        COMMENT '생성시간', 
    `updated_at`               DATETIME         NULL                        COMMENT '수정시간', 
    PRIMARY KEY (id)
)ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

ALTER TABLE sellers_info_snapshot COMMENT '셀러_정보_스냅샷 테이블';
...
(
    `id`                   BIGINT          NOT NULL    AUTO_INCREMENT   COMMENT 'id', 
    `accounts_id`          BIGINT          NULL                         COMMENT '계정테이블_id', 
    `auth_groups_menu_id`  BIGINT          NULL                         COMMENT '권한_그룹테이블_id', 
    `account`              VARCHAR(20)     NOT NULL                     COMMENT '계정', 
    `password`             VARCHAR(300)    NOT NULL                     COMMENT '비밀번호', 
    `name_kr`              VARCHAR(45)     NOT NULL                     COMMENT '이름(한글)', 
    `name_en`              VARCHAR(45)     NOT NULL                     COMMENT '이름(영문)', 
...
ALTER TABLE masters_snapshot COMMENT '마스터 테이블_스냅샷';
...
ALTER TABLE sellers_snapshot COMMENT '셀러 테이블_스냅샷';
